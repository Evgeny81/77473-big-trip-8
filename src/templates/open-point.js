import offersTemplate from './offers';
import pictureTemplate from './pictures';

export default ({description, offers, price, picture}) => {
    ...
    <section class="point__details">
      <section class="point__offers">
        ...
        <div class="point__offers-wrap">
          ${offers.map((offer) => (offersTemplate(offer, price))).join(``)}
        </div>
      ...
      <section class="point__destination">
        ...
        <div class="point__destination-images">
          ${[1, 2, 3, 4, 5].map(() => (pictureTemplate(picture))).join(``)}
        </div>
      </section>
